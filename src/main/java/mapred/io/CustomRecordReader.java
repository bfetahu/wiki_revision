...
/**
 * Treats keys as offset in file and values as line.
 */
@InterfaceAudience.LimitedPrivate({"MapReduce", "Pig"})
@InterfaceStability.Evolving
public class CustomRecordReader extends RecordReader<LongWritable, TextList> {
    ...
    @Override
    public TextList getCurrentValue() {
        return values;
    }
